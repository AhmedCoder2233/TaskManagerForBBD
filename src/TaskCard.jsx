...
const confirmDelete = async () => {
  try {
    ...
    // Also check and delete other potential related records
    // Add similar checks for attachments, comments if they have foreign key constraints
    ...
    if (deleteAttachmentsError && deleteAttachmentsError.code !== '42P01') {
      // Ignore error if attachments table doesn't exist
      console.warn('Could not delete attachments:', deleteAttachmentsError);
    }
    ...
    if (deleteCommentsError && deleteCommentsError.code !== '42P01') {
      // Ignore error if comments table doesn't exist
      console.warn('Could not delete comments:', deleteCommentsError);
    }
